'''
MOnkey patching is making assignments into some other namespace
...
def better_area_triangle(base, height):             # Step 2:  Write a wrapper function
    ...
    try:
        ...
        raise ValueError('Negative base or height not supported, use positive inouts instead')    
...
if __name__ == '__main__':
    ...
    print u'My sources tell me that \N{greek small letter pi} is eactly:', algebra.pi
    print 'and that the area of the circle of raius ten is:', algebra.area(10)
