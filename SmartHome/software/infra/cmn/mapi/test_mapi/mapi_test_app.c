...
#define TEST_MAPI_DGRAM_NUM_MIDS    2
#define TEST_MAPI_STREAM_NUM_MIDS   2
...
int main() {
    ...
    //uint16_t port_nums[TEST_MAPI_DGRAM_NUM_MIDS] = {5000, 6000};
    //test_app_mapi_dgram(TEST_MAPI_DGRAM_NUM_MIDS, port_nums);
  
#ifdef TEST_APP_1  
    uint16_t port_nums[TEST_MAPI_STREAM_NUM_MIDS] = {8000, 8001};
#endif
#ifdef TEST_APP_2 
    uint16_t port_nums[TEST_MAPI_STREAM_NUM_MIDS] = {8002, 8003};
#endif    

    test_app_mapi_stream(TEST_MAPI_STREAM_NUM_MIDS, port_nums);
