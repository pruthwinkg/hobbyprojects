...
BEGIN_ENUM(SYS_MGR_CLIENTS) {
    ...
    ADD_ENUM_STR(SYS_MGR_CLIENT_INTERFACE_MANAGER, "Interface Manager")
...
BEGIN_ENUM(SYS_MGR_SYSTEM_UID) {
    ...
    ADD_ENUM_VAL(SYS_MGR_SYSTEM_UID_INTERFACE_MANAGER, SMARTHOME_SUBSYSTEM_INTERFACE_MANAGER)
