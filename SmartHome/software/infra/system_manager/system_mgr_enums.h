...
BEGIN_ENUM(SYS_MGR_SHM_ID) {
    ...
    ADD_ENUM_STR(SYS_MGR_SHM_ID_COMM_MANAGER_PROTO_TBL, "Communication Manager SHM ID for Protocol")
    ADD_ENUM_STR(SYS_MGR_SHM_ID_APP_MANAGER, "Application Manager SHM ID")
